...
#if you do not have the code (which you wont to start with) tell me which chapter of code the answer will be in that i can copy and paste to you. 
#you can choose from either Chapter 5.3 - integration
#Chapter 6.1 - optimisation Single variable 
#Chapter 6.2 - optimisation multivariable
